...
$(function(){
    ...
    // 鍏朵粬椤甸潰鍔犺浇鏂囦欢锛坢etv6銆佽€佹ā鏉裤€乁I妯℃澘shop椤甸潰锛�
        ...
        var interval_appload=setInterval(function(){
                if(M['plugin']){
                    ...
                    if($('.met-showproduct').length){
                        if($('script[src*="js/basic_web.js"]').length){// 鑰佹ā鏉胯皟鐢ㄥ晢鍩庨粯璁ら〉闈�
                            M['plugin']['tablesaw']=[
                            ...
                            $.include([
                                M['url']['uiv2_js']+'editor.js',// 缂栬緫鍣�
                                M['url']['uiv2_js']+'img_slick.js',// 灞曠ず鍥剧墖杞挱鍥�
                                M['url']['uiv2_js']+'product.js',// 浜у搧妯″潡
                            ]);
                        }
